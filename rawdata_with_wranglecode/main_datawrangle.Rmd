...
#NOTE ERROR IN PREREGISTERED SURVEY THAT INCLUDED THE WRONG VERSION OF 'INFORMED, ITEM 4' (in the final survey, this item was reworded to be positvely phrased, so only informed, item 3 required reverse scoring)
