---
title: "Experiment testing the impact of digital imprints on organic campaign material: analysis plan generated from pilot study data"
author: 
-   name: Kate Dommett
-   name: Tom Stafford
-   name: Junyan Zhu
...
The purpose of this document is to develop an analysis plan from the pilot data before the main dataset is collected. The pilot results themselves are not interpreted or used, rather the models and visualisations have been created to increase clarity on how the measures address the hypotheses, and how the hypotheses address the research question. Faults in the pilot survey are also checked for.

### Research themes and questions

Research theme 1: the effect of viewing a digital imprint on subsequent evaluations

- **Research question 1a**: Does the presence of a digital imprint increase citizens knowledge about the source of digital campaign material?
- **Research question 1b**: Does the presence of a digital imprint increase the perceived trustworthiness of the campaign material?

Research theme 2: the effect of being informed about the purpose of digital imprints on subsequent evaluations

- **Research question 2a**: How does being informed about the purpose of digital imprints affect citizens' knowledge of the source of campaign material?
- **Research question 2b**: How does being informed about the purpose of digital imprints affect citizens' perceptions of the trustworthiness of such material?
- **Research question 2c**: How does being informed about the purpose of a digital imprint affect citizen views on the sufficiency of current regulatory oversight?

Research theme 3: citizen perceptions of direct and indirect transparency on citizen evaluations

- **Research question 3a**: Do citizens view information transparency information useful for the self and for others? 
- **Research question 3b**: Does the perception of how useful transparency information is to the self affect citizen trust in campaign material and confidence in regulatory oversight?
...
- H2: The presence of a digital imprint that does not communicate partisan cues on campaign material from a non-party campaign group will not affect the perceived trustworthiness of the campaign material.

Research question 2a:

- H3a: Those who are informed about the purpose of digital imprints, thus are primed to notice their presence and understand their purpose, will pay more attention to the presence or absence of source transparency when evaluating a piece of campaign material.
- H3b: Those who are informed about the purpose of digital imprints, thus are primed to notice their presence and understand their purpose, will pay more attention to the source of a campaign post.
- H3c: Those who are informed about the purpose of digital imprints will perceive themselves as informed about the source of a piece of material *if and only if* a digital imprint is present with the content.
- H3d: Those who are informed about the purpose of digital imprints will be more likely to both have confidence in their knowledge of the source, as well as recall this information with more accuracy.

Research question 2b:

- H4: Those who are informed about the purpose of digital imprints will perceive campaign content as more trustworthy *if and only if* a digital imprint is present with the content.

Research question 2c:

- H5: Those who are informed about the purpose of an imprint are more likely to perceive campaign laws as sufficient compared to those who are not informed about the purpose.

Research question 3a:

- H6: Individuals will vary in how relevant they perceive transparency information to be for voters (the self) or other actors.

Research question 3b:

- H7a: Variations in perceptions of the relevancy of campaign information will predict how trustworthy campaign materials are evaluated to be, with ranking transparency information as incrementally more useful to voters decreasing the likelihood campaign content will be perceived as trustworthy.
- H7b: Variations in perceptions of the relevancy of campaign information will predict the perceived sufficiency of regulatory oversight, with ranking transparency information as incrementally more useful to voters decreasing the likelihood campaign regulation will be perceived as sufficient.
...
This measure is used to understand how voters interpret the relevance of such information to their own evaluations.

It is additionally theorised this measure can capture distinctions between direct and indirect transparency perceptions. When citizens perceive transparent information as useful to others, they are theorised to express more trust in the campaign material they view overall and higher confidence in regulatory oversight for political advertising.

On the other hand, as digital imprints alone are fairly uninformative about the kinds of information voters might want to learn, such as detailed financial records of campaign sponsors and ideological biases, voters who perceive this information as relevant to the self may express lower trust in campaign material overall and lower confidence in regulatory oversight.

#### Measurement of usefulness ranking

Each response obtains a number indicating the rated position for each participant. All are numerical ranging from 1-6.
...
- Agreement with the content of the campaign post

Capturing agreement with the content of the post proxies political alignment and is necessary to include as political alignment is a strong predictor of trust in the content of advertisements. What is of interest is if digital imprints can have an effect on attitudes distinct from this.

- Knowledge of existing regulation

This control is relevant to the specific domain context, as perceptions of regulation are likely impacted by knowledge of regulation.

- Political party identification

This is another measure that captures political alignment.

Other variables important in perceptions of political information are captured:
...
- Political interest
- Political efficacy
- Facebook use and frequency

## Analysis plan: hypothesis 1a, 1b and 1c
...
### Hypothesis 1c: outcome: perceived informedness {.tabset}
...
### Supplementary check: advert level variations {.tabset}
...
## Analysis plan: hypothesis 2

### Hypothesis 2: outcome: accuracy, believability, factualness, trustworthiness {.tabset}
...
## Analysis plan: hypothesis 3a, 3b, 3c and 3d

### Hypothesis 3a: outcome: number recall {.tabset}
...
### Hypothesis 3b: outcome: correct name recall {.tabset}
...
### Hypothesis 3c: outcome: perceived informedness {.tabset}
...
### Hypothesis 3d: outcome: correct versus incorrect recall {.tabset}
...
## Analysis plan: hypothesis 4

### Hypothesis 4: outcome: accuracy, believablity, factualness, trustworthiness {.tabset}
...
## Analysis plan: hypothesis 5

### Hypothesis 5: outcome: confidence in regulation {.tabset}
...
## Analysis plan: hypothesis 6

### Hypothesis 6: outcome: rank position {.tabset}
...
## Analysis plan: hypothesis 7

### Hypothesis 7a: outcome: trustworthiness {.tabset}
...
### Hypothesis 7b: outcome: regulation confidence {.tabset}
