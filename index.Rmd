...
### Outcome: Persuasion Knowledge {.tabset}
...
From this assessment, it was decided the three measures of trustworthy, accuracy and believable would be averaged into one 'credibility' factor, and the factual-opinionated measure would be tested seperately.
...
- model 5 <- lmer(credible ~ Training.condition + version + agree_value + Training.condition*version + (1|id) + (1|advert))
